...
typedef NS_ENUM(NSInteger, COListMode) {
	kCOListModeAllFormulae,
	kCOListModeInstalledFormulae,
	kCOListModeLeaves,
	kCOListModeOutdatedFormulae,
	kCOListModeSearchFormulae, /* Don't call -[COHomebrewInterface listMode:] with this parameter. */
    
	kCOListModeRepositories,
	
	kCOListModeAllCasks,
	kCOListModeInstalledCasks,
	kCOListModeOutdatedCasks,
	kCOListModeSearchCasks
};

@protocol COHomebrewInterfaceDelegate <NSObject>
...
@interface COHomebrewInterface : NSObject <COFormulaDataProvider>
 ...
 *  The delegate object.
 */
@property (weak, nonatomic) id<COHomebrewInterfaceDelegate> delegate;
 ...
 *
 *  @return List of COFormula objects.
 */
- (NSArray*)packagesWithMode:(COListMode)mode;
